...
## 最新版本：`v2.49.0`（2026-09-19）

👉 [查看 Release 说明与校验和](https://github.com/redtidev1918/TelePost/releases/tag/v2.49.0)

| 平台 | 文件 | 大小 | 下载 |
|---|---|---|---|
| Linux · x64 | `telepost-2.49.0-linux-x64.tar.gz` | 35.2 MB | [⬇️ 下载](https://github.com/redtidev1918/TelePost/releases/download/v2.49.0/telepost-2.49.0-linux-x64.tar.gz) |
| Linux · x64 | `telepost-linux-x64` | 35.5 MB | [⬇️ 下载](https://github.com/redtidev1918/TelePost/releases/download/v2.49.0/telepost-linux-x64) |
| Windows · x64 | `telepost-2.49.0-windows-x64.zip` | 21.3 MB | [⬇️ 下载](https://github.com/redtidev1918/TelePost/releases/download/v2.49.0/telepost-2.49.0-windows-x64.zip) |
